from sobel_edge import load_image, save_image, sobel_edge, sobel_gradient_direction, classify_direction, compare_plot, save_image
...
# 可视化对比（原图 vs 边缘图）
compare_plot(img, edge_filtered, show=True)